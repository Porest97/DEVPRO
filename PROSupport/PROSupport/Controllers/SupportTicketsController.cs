...
namespace PROSupport.Controllers
{
    public class SupportTicketsController : Controller
    {
        ...
        public SupportTicketsController(PROSupportContext context)
        {
            _context = context;
        }
        ...
        {
            var pROSupportContext = _context.SupportTicket.Include(s => s.AssignedFE).Include(s => s.BusinessCentre).Include(s => s.OrderedBy);
        ...
        {
            ViewData["PersonId1"] = new SelectList(_context.Person, "Id", "STString");
            ViewData["BusinessCentreId"] = new SelectList(_context.BusinessCentre, "Id", "CName");
        ...
        public async Task<IActionResult> Create([Bind("Id,TimeStampCreated,TimeStampResolved,TimeStampClosed,BusinessCentreId,PersonId,PersonId1,FaultDescription,FaultReport,TicketLog")] SupportTicket supportTicket)
        {
            ...
            ViewData["PersonId1"] = new SelectList(_context.Person, "Id", "STString", supportTicket.PersonId1);
            ViewData["BusinessCentreId"] = new SelectList(_context.BusinessCentre, "Id", "CName", supportTicket.BusinessCentreId);
            ViewData["PersonId"] = new SelectList(_context.Person, "Id", "STString", supportTicket.PersonId);
            return View(supportTicket);
        }
