...
namespace NetelloBusinessSolution.Controllers
{
    public class InvoicesController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Invoice.Include(i => i.Article).Include(i=>i.ArticlePrice).Include(i => i.BillTo).Include(i => i.Company);
            invoice.Amount = invoice.Article.Price * invoice.Qantity1.Value;
            return View(invoice);
        }
        ...
        {
            ViewData["ArticleId"] = new SelectList(_context.Set<Article>(), "Id", "ArticleDescription");
            ViewData["ArticleId1"] = new SelectList(_context.Set<Article>(), "Id", "Price");
        ...
        public async Task<IActionResult> Create([Bind("Id,CompanyId,CompanyId1,Qantity1,ArticleId,ArticleId1,Amount")] Invoice invoice)
        {
            ...
            ViewData["ArticleId"] = new SelectList(_context.Set<Article>(), "Id", "ArticleDescription", invoice.ArticleId);
            ViewData["ArticleId1"] = new SelectList(_context.Set<Article>(), "Id", "Price", invoice.ArticleId1);
