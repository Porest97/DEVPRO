...
namespace NetelloBusinessSolution.Controllers
{
    public class PurchaseOrdersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,PurchaseOrderNumber,BusinessCentreId,PersonId,PersonId1,Descrition,TimeOnSite,KostPerHour,TotalKost,JobbScheduled,JobbStarted,JobbEnded")] PurchaseOrder purchaseOrder)
        {
            ...
            ViewData["PersonId1"] = new SelectList(_context.Person, "Id", "FullName", purchaseOrder.PersonId1);
            ViewData["BusinessCentreId"] = new SelectList(_context.BusinessCentre, "Id", "CName", purchaseOrder.BusinessCentreId);
            ViewData["PersonId"] = new SelectList(_context.Person, "Id", "FullName", purchaseOrder.PersonId);
            return View(purchaseOrder);
        }
