...
namespace NetelloBusinessSolution.Controllers
{
    public class SupportCasesController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["PurchaseOrderId"] = new SelectList(_context.PurchaseOrder, "Id", "PurchaseOrderNumber");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,TimeReported,TimeStarted,TimeFEScheduled,TimeSolved,TotalTimeOnSite,BusinessCentreId,PersonId,PersonId1,Descrition,PurchaseOrderId")] SupportCase supportCase)
        {
            ...
            ViewData["PersonId1"] = new SelectList(_context.Person, "Id", "CName", supportCase.PersonId1);
            ViewData["BusinessCentreId"] = new SelectList(_context.BusinessCentre, "Id", "CName", supportCase.BusinessCentreId);
            ViewData["PersonId"] = new SelectList(_context.Person, "Id", "CName", supportCase.PersonId);
            ViewData["PurchaseOrderId"] = new SelectList(_context.PurchaseOrder, "Id", "PurchaseOrderNumber", supportCase.PurchaseOrderId);
            return View(supportCase);
        }
