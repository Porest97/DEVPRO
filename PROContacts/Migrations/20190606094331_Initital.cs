        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AgeGroupName = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Person_AgeGroup_AgeGroupId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Person_Season_SeasonId",
                        column: x => x.SeasonId,
                        principalTable: "Season",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Person_Sport_SportId",
                        column: x => x.SportId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Person_SeasonId",
                table: "Person",
                column: "SeasonId");

            migrationBuilder.CreateIndex(
                name: "IX_Person_SportId",
                table: "Person",
                column: "SportId");
