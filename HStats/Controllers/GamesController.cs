...
namespace HStats.Controllers
{
    public class GamesController : Controller
    {
        ...
        public GamesController(HStatsContext context)
        {
            _context = context;
        }
        ...
        {
            var hStatsContext = _context.Game.Include(g => g.Arena).Include(g => g.AwayTeam).Include(g => g.HomeTeam).Include(g => g.Person).Include(g => g.Person1).Include(g => g.Person2).Include(g => g.Person3).Include(g => g.Person4).Include(g => g.Series);
        ...
        public async Task<IActionResult> Create([Bind("Id,MatchNumber,MatchDateTime,ArenaId,TeamId,TeamId1,HomeTeamScore,AwayTeamScore,PersonId,PersonId1,PersonId2,PersonId3,PersonId4,SeriesId,TSMNumber,TimeStamp")] Game game)
        {
            ...
            ViewData["TeamId1"] = new SelectList(_context.Set<Team>(), "Id", "TeamName", game.TeamId1);
            ViewData["TeamId"] = new SelectList(_context.Set<Team>(), "Id", "TeamName", game.TeamId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,MatchNumber,MatchDateTime,ArenaId,TeamId,TeamId1,HomeTeamScore,AwayTeamScore,PersonId,PersonId1,PersonId2,PersonId3,PersonId4,SeriesId,TSMNumber,TimeStamp")] Game game)
        {
            if (id != game.Id)
            {
                return NotFound();
